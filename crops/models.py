...
class Plot(models.Model):
    """10cm x 10cm の最小単位"""
    area = models.ForeignKey(GardenArea, on_delete=models.CASCADE, related_name='all_plots')
...
class VegetableType(models.Model):
    ...
    spacing_cm = models.PositiveIntegerField("栽培間隔(cm)", default=50, help_text="株間の目安（例：トマトなら50cm）")
...
class MaintenanceLog(models.Model):
    ...
    area = models.ForeignKey(GardenArea, on_delete=models.CASCADE, related_name='maintenance_logs')
    # 何をしたか
